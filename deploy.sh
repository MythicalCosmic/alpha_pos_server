...
# AI assistant (Gemini). The key is preserved across redeploys via keep() — set it
# once in .env (never committed to git). Provider + model are safe to bake.
...
# --- AI assistant (LLM) — server-side only, Gemini ---
AI_PROVIDER=gemini
