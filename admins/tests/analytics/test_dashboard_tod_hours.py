"""Dashboard and order time-of-day filters, hourly single-day series,
...
def test_product_ids_filter_orders_and_stats():
    ...
    c = _u()
    o1 = _order(20000, _utc(2026, 7, 8, 6), cashier=c)
    _item(o1, p1, 2, 10000)
    o2 = _order(30000, _utc(2026, 7, 8, 6), cashier=c)
    _item(o2, p2, 3, 10000)
...
def test_daily_stats_bucket_is_business_day():
    ...
    # 2026-07-08 01:00 local (= 2026-07-07 20:00 UTC) is before the 03:00 close,
    # so it belongs to the 2026-07-07 operating date.
