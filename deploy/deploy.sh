...
# Smart Food customer Telegram bot (Mini App). Token baked in by default so the
# canonical deploy provisions the bot service without manual steps; an existing
# .env value wins via keep().
A_CBOT="$(keep "$A_ENV" CUSTOMER_BOT_TOKEN)"; A_CBOT="${A_CBOT:-8783914595:AAFaThtUdYIzPXt9Sj0gvrhIGMG7f3_BLos}"
